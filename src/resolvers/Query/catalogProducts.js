...
import { decodeShopOpaqueId, decodeTagOpaqueId, decodeProductOpaqueId } from "../../xforms/id.js";
 ...
 */
export default async function catalogProducts(_, args, context, info) {
  const {
    shopIds: opaqueShopIds,
    tagIds: opaqueTagIds,
    excludeProductIds: opaqueExcludeProductIds,
    booleanFilters,
    tagSlugs,
    tagMatchs,
    ...connectionArgs
  ...
  const excludeProductIds = opaqueExcludeProductIds && opaqueExcludeProductIds.map(decodeProductOpaqueId);
